...
const mockSubmissions: Submission[] = [
    ...
    questions: [
      {
        ...
        questionType: "essay",
        learnerAnswer:
          "React hooks are functions that allow you to use state and other React features in functional components. Examples include useState for managing state and useEffect for handling side effects.",
        correctAnswer:
          "React hooks are functions that allow you to use state and other React features in functional components. Examples include useState for managing state and useEffect for handling side effects.",
        points: 50,
        earnedPoints: 0,
  ...
  },
  {
    ...
    feedback:
      "Good work overall! Your coding solution was efficient. Consider adding more detail to your explanations.",
    gradedBy: "Alex Chen",
    ...
    questions: [
      {
        ...
        learnerAnswer:
          "The leader demonstrates transformational leadership by inspiring and motivating the team.",
        correctAnswer:
          "The leader demonstrates transformational leadership by inspiring and motivating the team.",
        points: 100,
        earnedPoints: 92,
        feedback:
          "Excellent analysis with good examples. Could include more critical evaluation.",
        isCorrect: true,
      },
    ],
    feedback:
      "Outstanding work! Your analysis shows deep understanding of leadership concepts.",
...
const GradingPage = () => {
  ...
  const [gradingData, setGradingData] = useState<{
    [key: string]: { points: number; feedback: string };
  }>({});
  ...
  const filteredSubmissions = mockSubmissions.filter((submission) => {
    ...
    const matchesAssessment =
      ...
      submission.assessmentName === assessmentFilter;
  ...
  const quickStats = [
    ...
    },
    {
      ...
      value: mockSubmissions.filter((s) => s.status === "feedback-given")
        .length,
      icon: MessageSquare,
      color: "text-blue-600",
    },
  ...
  const uniqueAssessments = [
    ...new Set(mockSubmissions.map((s) => s.assessmentName)),
  ];
  ...
  const handleSaveGrade = () => {
    ...
    const updatedSubmission = {
      ...
      percentage: Math.round(
        (totalScore / selectedSubmission.totalPoints) * 100
      ),
  ...
  return (
    <div className="p-6 bg-slate-900 min-h-screen space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold text-white">Grading & Feedback</h1>
          <p className="text-slate-300">
            Grade assessments and provide feedback to learners
          </p>
        </div>
      ...
      <div className="flex items-center justify-between">
        <p className="text-sm text-gray-600">
          Showing {filteredSubmissions.length} of {mockSubmissions.length}{" "}
          submissions
        </p>
      </div>
          ...
          <table className="min-w-full divide-y divide-slate-700">
            ...
            <tbody className="bg-slate-800 divide-y divide-slate-700">
              {filteredSubmissions.map((submission) => {
                ...
                return (
                  <tr key={submission.id} className="hover:bg-slate-700">
