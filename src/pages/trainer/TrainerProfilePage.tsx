    ...
    <div className="p-6 space-y-6 bg-slate-900 min-h-screen">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-slate-300">Manage your personal information and training profile</p>
        </div>
            ...
            <div className="text-center">
              ...
              <h2 className="text-xl font-bold text-white mb-2">
                {isEditing ? (
                  <input
                    ...
                    className="text-center bg-slate-700 border border-slate-600 text-white rounded px-2 py-1 w-full"
                  />
                ) : (
                  profile.firstName
                )}{" "}
                {isEditing ? (
                  <input
                    ...
                    className="text-center bg-slate-700 border border-slate-600 text-white rounded px-2 py-1 w-full mt-2"
                  />
                ) : (
                  profile.lastName
                )}
              ...
              <div className="space-y-3 text-left">
                  ...
                  <span className="text-sm text-slate-300">
                    {isEditing ? (
                      <input
                        ...
                        className="bg-slate-700 border border-slate-600 text-white rounded px-2 py-1 w-full"
                      />
                    ) : (
                      profile.email
                    )}
                ...
                <div className="flex items-center">
                  ...
                  <span className="text-sm text-slate-300">Hired: {profile.hireDate}</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-slate-800 rounded-lg border border-slate-700 p-6">
            ...
            <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
              <div className="text-center">
                ...
                <p className="text-2xl font-bold text-white">{mockStats.totalPrograms}</p>
              ...
              <div className="text-center">
                ...
                <p className="text-2xl font-bold text-white">{mockStats.totalLearners}</p>
              ...
              <div className="text-center">
                ...
                <p className="text-2xl font-bold text-white">{mockStats.totalHours}</p>
          ...
          <div className="bg-slate-800 rounded-lg border border-slate-700 p-6">
            ...
            {isEditing ? (
              <textarea
                ...
                rows={4}
                className="w-full bg-slate-700 border border-slate-600 text-white rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:border-transparent"
              />
            ) : (
