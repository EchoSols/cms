...
const IndividualProgressPage = () => {
  ...
  const filteredProgress = progress.filter((learner) => {
    ...
    const matchesProgram =
      programFilter === "all" || learner.programName === programFilter;
  ...
  const quickStats = [
    ...
    },
    {
      ...
      value: progress.filter((p) => p.status === "active").length,
      icon: Activity,
    ...
    {
      label: "At Risk",
      value: progress.filter((p) => p.status === "at-risk").length,
      icon: Target,
  ...
  return (
    <div className="p-6 bg-slate-900 min-h-screen space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold text-white">Individual Progress</h1>
          <p className="text-slate-300">
            Track and monitor individual learner progress across all programs
          </p>
        </div>
              ...
              <div>
                ...
                <div className="space-y-2">
                  ...
                  <div>
                    ...
                    >
                      {selectedLearner.status.charAt(0).toUpperCase() +
                        selectedLearner.status.slice(1)}
                    </span>
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="space-y-2">
                  <div>
                    ...
                    <span
                      className={`ml-2 text-sm font-medium ${getProgressColor(
                  ...
                  <div>
                    ...
                    <span className="ml-2 text-sm text-gray-900">
                      {selectedLearner.completedModules}/
                      {selectedLearner.totalModules}
                    </span>
                  </div>
                  <div>
                    <span className="text-sm font-medium text-gray-600">
                    ...
                    <span className="ml-2 text-sm text-gray-900">
                      {selectedLearner.completedAssessments}/
                      {selectedLearner.totalAssessments}
                    </span>
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="space-y-2">
                  <div>
                    ...
                    <span
                      className={`ml-2 text-sm font-medium ${getScoreColor(
                        selectedLearner.averageScore
                      )}`}
                    >
                      {selectedLearner.averageScore > 0
                        ? `${selectedLearner.averageScore}%`
                        : "N/A"}
                    </span>
                  </div>
