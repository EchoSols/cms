...
const LearnersPage = () => {
  ...
  const filteredLearners = mockLearners.filter((learner) => {
    ...
    const matchesDepartment =
      ...
      learner.department === selectedDepartment;
    const matchesStatus =
      selectedStatus === "" ||
      selectedStatus === "All Status" ||
      learner.status === selectedStatus;
  ...
  return (
    <div className="p-6 bg-slate-900 min-h-screen max-w-7xl mx-auto">
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-white mb-2">All Learners</h1>
        <p className="text-slate-300">
          Manage and monitor all learners enrolled in your training programs
        </p>
      </div>
        ...
        <div className="bg-slate-800 p-6 rounded-lg border border-slate-700">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-2xl font-bold text-white">
                {
                  mockLearners.filter((learner) => learner.status === "active")
                    .length
                }
              </p>
            </div>
          ...
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-2xl font-bold text-white">
                {Math.round(
                  mockLearners.reduce(
                    (sum, learner) => sum + learner.completionRate,
                    0
                  ) / mockLearners.length
                )}
                %
        ...
        <div className="bg-slate-800 p-6 rounded-lg border border-slate-700">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-2xl font-bold text-white">
                {mockLearners.reduce(
                  (sum, learner) => sum + learner.totalCourses,
                  0
                )}
              </p>
            </div>
              ...
              <div className="p-6">
                <div className="flex items-start justify-between mb-4">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    >
                      {learner.status.charAt(0).toUpperCase() +
                        learner.status.slice(1)}
                    </span>
                ...
                <div className="flex gap-2">
                  <button
                    ...
                    className="flex-1 bg-blue-600 text-white px-3 py-2 rounded-md text-sm font-medium hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 flex items-center justify-center gap-2"
                  >
                  ...
                  <button
                    ...
                    className="px-3 py-2 text-slate-400 hover:text-slate-300 hover:bg-slate-700 rounded-md"
                    title="Edit Learner"
                  >
                  ...
                  <button
                    ...
                    className="px-3 py-2 text-blue-400 hover:text-blue-300 hover:bg-blue-900 rounded-md"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm">
                    Enrolled: {formatDate(selectedLearner.enrollmentDate)}
                  </span>
                </div>
              </div>
              ...
              <div className="grid grid-cols-3 gap-4">
                <div className="text-center p-4 bg-gray-50 rounded-lg">
                  <div className="text-2xl font-bold text-primary-600">
                    {selectedLearner.totalCourses}
                  </div>
                  <div className="text-sm text-gray-600">Total Courses</div>
                </div>
                <div className="text-center p-4 bg-gray-50 rounded-lg">
                  <div className="text-2xl font-bold text-green-600">
                    {selectedLearner.completedCourses}
                  </div>
                  <div className="text-sm text-gray-600">Completed</div>
                </div>
                <div className="text-center p-4 bg-gray-50 rounded-lg">
                  <div className="text-2xl font-bold text-blue-600">
                    {selectedLearner.completionRate}%
                  </div>
