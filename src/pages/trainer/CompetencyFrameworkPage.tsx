...
const CompetencyFrameworkPage = () => {
  ...
  return (
    <div className="p-6 bg-slate-900 min-h-screen">
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-white mb-2">Competency Framework</h1>
        <p className="text-slate-300">Define and manage competency frameworks for training and development</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
        <div className="bg-slate-800 p-6 rounded-lg shadow-sm border border-slate-700">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <p className="text-sm font-medium text-slate-300">Total Competencies</p>
        ...
        <div className="bg-slate-800 p-6 rounded-lg shadow-sm border border-slate-700">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <p className="text-sm font-medium text-slate-300">Archived</p>
      ...
      <div className="space-y-4">
        {filteredCompetencies.map((competency) => (
          <div key={competency.id} className="bg-slate-800 rounded-lg shadow-sm border border-slate-700 p-6">
            <div className="flex items-start justify-between">
              <div className="flex-1">
                <div className="flex items-center gap-3 mb-2">
                  <h3 className="text-lg font-medium text-white">{competency.name}</h3>
                  <span
                    className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${getLevelColor(competency.level)}`}
                  >
                    {competency.level}
                  </span>
                  <span
                    className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${getImportanceColor(competency.importance)}`}
                  >
                    {competency.importance}
                  </span>
                </div>

                <p className="text-slate-300 mb-3">{competency.description}</p>
              ...
              <div className="flex items-center gap-2">
                <button className="p-2 text-slate-400 hover:text-slate-200 rounded-lg hover:bg-slate-700">
                ...
                <button className="p-2 text-red-400 hover:text-red-300 rounded-lg hover:bg-red-900/20">
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-slate-800 rounded-lg p-6 max-w-md w-full mx-4 border border-slate-700">
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-lg font-medium text-white">Create New Competency</h3>
            ...
            <div className="space-y-4">
              <div>
                <label className="block text-sm font-medium text-slate-300 mb-1">Competency Name</label>
                <input
                  type="text"
