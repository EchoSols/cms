...
const mockCareerPaths: CareerPath[] = [
  {
    ...
    description:
      "Progression path from individual contributor to technical leadership",
  ...
  },
  {
    ...
    description:
      "Progression from individual sales to sales leadership and strategy",
    department: "Sales",
    level: "Senior",
...
const mockDevelopmentPlans: DevelopmentPlan[] = [
  {
    ...
    milestones: [
      ...
      {
        name: "Architecture Design Certification",
        completed: false,
        dueDate: "2024-10-15",
      },
    ],
...
const CareerDevelopmentPage = () => {
  ...
  const filteredPaths = mockCareerPaths.filter((path) => {
    ...
    const matchesDepartment =
      departmentFilter === "All" || path.department === departmentFilter;
  ...
  const stats = {
    ...
    totalParticipants: mockCareerPaths.reduce(
      (acc, path) => acc + path.participants,
      0
    ),
    avgCompletionRate: Math.round(
      mockCareerPaths.reduce((acc, path) => acc + path.completionRate, 0) /
        mockCareerPaths.length
    ),
  };
    ...
    <div className="p-6 bg-slate-900 min-h-screen">
      ...
      <div className="mb-8">
        ...
        <p className="text-slate-300">
          Manage career development programs and individual development plans
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
        ...
        <div className="bg-slate-800 p-6 rounded-lg border border-slate-700">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <p className="text-sm font-medium text-slate-300">Active Paths</p>
              <p className="text-2xl font-bold text-white">
                {stats.activePaths}
              </p>
            </div>
            ...
            {filteredPaths.map((path) => (
              ...
              >
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-1">
                      {path.skills.slice(0, 3).map((skill, index) => (
                        <span
                          key={index}
                          className="inline-block px-2 py-1 bg-blue-900 text-xs text-blue-200 rounded"
                        >
                          {skill}
                        </span>
                      ))}
                      {path.skills.length > 3 && (
                        <span className="inline-block px-2 py-1 bg-slate-700 text-xs text-slate-300 rounded">
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-1">
                      {path.certifications.map((cert, index) => (
                        <span
                          key={index}
                          className="inline-block px-2 py-1 bg-green-900 text-xs text-green-200 rounded"
                        >
                          {cert}
                        </span>
                      ))}
                ...
                <div className="flex space-x-2">
                  ...
                  <button className="flex-1 px-3 py-2 text-sm text-slate-400 hover:text-slate-300 flex items-center justify-center">
            ...
            >
              <div className="flex items-center justify-between mb-4">
                <div>
                  ...
                  <p className="text-xs text-slate-500">{plan.careerPath}</p>
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                <div>
                  ...
                  <p className="font-medium text-white">{plan.startDate}</p>
                </div>
                <div>
                  <p className="text-sm text-slate-400">Target Date</p>
                  <p className="font-medium text-white">{plan.targetDate}</p>
                </div>
                <div>
