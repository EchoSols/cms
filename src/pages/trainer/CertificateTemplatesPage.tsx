  ...
  return (
    <div className="p-6 bg-slate-900 min-h-screen">
      ...
      <div className="mb-8">
        ...
        <p className="text-slate-300">Create and manage certificate templates for different programs</p>
      </div>
      ...
      <div className="flex justify-between items-center mb-6">
        ...
        <div className="flex gap-3">
          <button className="px-4 py-2 border border-slate-600 text-slate-300 rounded-lg hover:bg-slate-800 transition-colors duration-200 flex items-center">
          ...
          >
            ...
            <div className="h-48 bg-gradient-to-br from-slate-700 to-slate-800 flex items-center justify-center relative">
              <div className="text-center">
                ...
                <p className="text-sm text-slate-300">Template Preview</p>
              </div>
              ...
              <div className="absolute top-3 left-3">
                <span
                  className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${getDesignColor(template.designType)}`}
                >
                  {template.designType}
                </span>
              </div>
            ...
            <div className="p-6">
              ...
              <div className="mb-4">
                <p className="text-xs font-medium text-slate-300 mb-2">Color Scheme:</p>
              ...
              <div className="flex space-x-2">
                ...
                <button
                  ...
                  className="px-3 py-2 text-sm border border-slate-600 text-slate-300 rounded-lg hover:bg-slate-700 transition-colors duration-200"
                  title="Duplicate"
                >
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-slate-800 rounded-lg p-6 max-w-md w-full mx-4 border border-slate-700">
            ...
            <div className="space-y-4">
              ...
              <div>
                <label className="block text-sm font-medium text-slate-300 mb-1">Design Type</label>
                <select className="w-full px-3 py-2 bg-slate-700 border border-slate-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-white">
