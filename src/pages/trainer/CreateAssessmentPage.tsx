      ...
      setAssessment((prev) => ({
        ...
        questions: prev.questions?.map((q) =>
          q.id === editingQuestionId
            ? ({ ...currentQuestion, id: editingQuestionId } as Question)
            : q
        ),
      }));
  ...
  const steps = [
    {
      ...
      description: "Assessment details and settings",
    },
    {
      number: 2,
      title: "Questions",
    ...
    },
    {
      ...
      description: "Review and publish assessment",
    },
  ];
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-slate-300">
            Design comprehensive assessments and quizzes for learners
          </p>
        </div>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-xs text-gray-500">
                      Let learners retake the assessment
                    </p>
                  </div>
                  <label className="relative inline-flex items-center cursor-pointer">
                    <input
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-900">
                      {assessment.category || "Not specified"}
                    </p>
                  </div>
                  <div>
                    <span className="text-sm font-medium text-gray-600">
