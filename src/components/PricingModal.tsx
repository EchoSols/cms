      ...
      <div className="bg-slate-900 rounded-xl sm:rounded-2xl w-full max-w-6xl max-h-[95vh] sm:max-h-[90vh] overflow-y-auto scrollbar-hide scroll-smooth">
        ...
        <div className="p-4 sm:p-6 lg:p-8 border-b border-slate-700">
          <div className="flex items-center justify-between mb-4">
            <div>
              ...
              <p className="text-slate-300 mt-2 text-sm sm:text-base">Select the perfect plan for your organization</p>
            </div>
        ...
        <div className="p-4 sm:p-6 lg:p-8">
            ...
            {plans.map((plan, index) => (
              <div
                ...
                className={`relative border-2 rounded-xl p-4 sm:p-6 ${
                  plan.popular ? "border-slate-600 shadow-lg bg-slate-800" : "border-slate-700 bg-slate-800"
              ...
              >
                ...
                <div className="text-center mb-4 sm:mb-6">
                  ...
                  <p className="text-slate-300 text-xs sm:text-sm mb-4">{plan.description}</p>
                  <div className="mb-4">
          ...
          <div className="mt-8 text-center">
            <p className="text-slate-300 mb-4">Need a custom solution? Contact our sales team</p>
            <button className="text-white hover:text-slate-200 font-medium">Contact Sales →</button>
          </div>
        </div>
      </div>
    </div>
