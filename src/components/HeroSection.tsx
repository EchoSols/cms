      ...
      <div className="container-custom">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative">
            <div className="bg-slate-800 rounded-lg shadow-2xl p-6 transform rotate-3 hover:rotate-0 transition-transform duration-300 border border-slate-700">
              <div className="bg-slate-700 rounded-lg p-4 mb-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  {/* Bar Chart */}
                  <div className="bg-blue-600 rounded p-2 flex items-end justify-between">
                  ...
                  {/* Line Chart */}
                  <div className="bg-orange-600 rounded p-2 relative">
                  ...
                  {/* Donut Chart */}
                  <div className="bg-yellow-600 rounded p-2 flex items-center justify-center">
                    <div className="w-8 h-8 border-4 border-white rounded-full border-r-transparent"></div>
                  </div>

                  {/* Stats */}
                  <div className="bg-green-600 rounded p-2 text-white text-center">
