        ...
        <div className="p-4 sm:p-6 lg:p-8 border-b border-slate-700">
          <div className="flex items-center justify-between mb-4">
            <div>
              ...
              <p className="text-slate-300 mt-2 text-sm sm:text-base">We'd love to hear from you. Send us a message!</p>
            </div>
            <button onClick={onClose} className="p-2 hover:bg-slate-800 rounded-lg transition-colors duration-200">
              ...
              <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    required
                    rows={5}
                    className="w-full px-4 py-3 border border-slate-600 bg-slate-800 text-white rounded-lg focus:ring-2 focus:ring-slate-500 focus:border-slate-500 transition-colors duration-200 resize-none"
                ...
                <button
                  ...
                  className="w-full bg-white hover:bg-slate-100 disabled:bg-slate-400 text-slate-900 font-medium py-3 px-6 rounded-lg transition-colors duration-200 flex items-center justify-center"
                >
                  {isSubmitting ? (
                    <>
            ...
            <div>
              ...
              <div className="space-y-4 sm:space-y-6">
                <div className="flex items-start">
                  <div className="w-10 h-10 sm:w-12 sm:h-12 bg-slate-800 rounded-lg flex items-center justify-center mr-3 sm:mr-4 flex-shrink-0">
                    <Mail className="w-5 h-5 sm:w-6 sm:h-6 text-slate-300" />
                  </div>
                  <div>
                ...
                <div className="flex items-start">
                  <div className="w-10 h-10 sm:w-12 sm:h-12 bg-slate-800 rounded-lg flex items-center justify-center mr-3 sm:mr-4 flex-shrink-0">
                    <Phone className="w-5 h-5 sm:w-6 sm:h-6 text-slate-300" />
                  </div>
                  <div>
              ...
              <div className="mt-6 sm:mt-8 p-4 sm:p-6 bg-slate-800 rounded-lg">
